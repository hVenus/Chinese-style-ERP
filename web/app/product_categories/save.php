...
if($msg == ""){
    $sql = 'INSERT INTO product_categories SET parent_id=0, cate_name="'.mysql_real_escape_string($name).'", cate_code="'.mysql_real_escape_string($code).'", sort_no='.(int)$sort.', invalid=0 ';
