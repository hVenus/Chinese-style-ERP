...
if($msg == "" && is_numeric($id) && $id>0){
    $sql = 'UPDATE product_categories SET parent_id='.(int)$parent_id.', cate_name="'.mysql_real_escape_string($name).'", cate_code="'.mysql_real_escape_string($code).'", sort_no='.(int)$sort.' WHERE id='.(int)$id.' ';
