...
class Cache_Memcache{
    ...
    public function Cache_Memcache( $config = NULL ){
        if ( is_array( $config ) ){
        ...
        foreach ( $this->_memcache_conf as $name => $cache_server ){
            ...
            $r = $this->_memcached->addServer( $cache_server['hostname'], $cache_server['port'], $cache_server['persistent'], $cache_server['weight'] );
        }
    }
